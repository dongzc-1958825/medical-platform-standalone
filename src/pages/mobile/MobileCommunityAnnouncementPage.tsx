// src/pages/mobile/MobileCommunityAnnouncementPage.tsx
...
// ========== 主页面 ==========
const MobileCommunityAnnouncementPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const filtered = messages.filter((m: any) => 
      m.type === 'announcement' && m.community === communityName && m.communityType === communityType
    );
  ...
  const getUserInteraction = (msgId: string) => {
    const user = getCurrentUser();
    return user ? interactionData[`${user.id}_${msgId}`] || { liked: false } : { liked: false };
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 bg-white border-b z-10">
        <div className="flex items-center p-4">
          ...
          <h1 className="flex-1 text-center font-semibold">{communityName}公告</h1>
        </div>
      </div>
                ...
                <div className="flex items-center gap-4 text-sm border-t pt-3">
                  ...
                  <CollectButton
                    ...
                    itemData={{
                      ...
                      date: msg.date,
                      tags: msg.tags,
                      community: msg.community || communityName,
                      communityId: id,
                      type: communityType
                    }}
...
export default MobileCommunityAnnouncementPage;
