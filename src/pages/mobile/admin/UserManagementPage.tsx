...
useEffect(() => {
 ...
 const getRoleBadge = (role: string) => {
  switch(role) {
    case 'super_admin': return { bg: 'bg-purple-100', text: 'text-purple-700', label: '超级管理员' };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 grid grid-cols-4 gap-2">
        ...
        <div className="bg-white rounded-xl p-2 text-center">
          <div className="text-lg font-bold text-purple-600">{users.filter(u => u.role === 'super_admin' || u.role === 'admin').length}</div>
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        if (confirm(`确定要删除用户「${user.username}」吗？`)) {
                          ...
                          localStorage.setItem('medical-registered-users', JSON.stringify(filtered));
                          loadUsers();
                        }
                      }}
