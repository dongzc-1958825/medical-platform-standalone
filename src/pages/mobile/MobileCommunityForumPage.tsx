// src/pages/mobile/MobileCommunityForumPage.tsx
...
const IDENTITY_TYPES = {
  ...
  patient: { label: '病友', icon: HeartIcon, color: 'text-teal-600', bgColor: 'bg-teal-50' },
  other: { label: '其他', icon: UserPlus, color: 'text-gray-600', bgColor: 'bg-gray-50' }
};
      ...
      <div className="bg-white w-full max-w-md rounded-t-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-4 border-t">
          ...
          <div className="flex gap-2">
            ...
            />
            <button type="submit" className="px-4 py-2 bg-teal-600 text-white rounded-full">
...
// ========== 主页面 ==========
const MobileCommunityForumPage: React.FC = () => {
  ...
  useEffect(() => {
    const allPosts = loadAllForumPosts();
    const filtered = allPosts.filter((p: any) => p.community === communityName && p.communityType === communityType);
    setPosts(filtered);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 bg-white border-b z-10">
        <div className="flex items-center p-4">
          ...
          <h1 className="flex-1 text-center font-semibold">{communityName}社群之家</h1>
        </div>
      </div>
                ...
                <div className="flex items-center gap-4 text-sm border-t pt-3">
                  ...
                  <CollectButton
                    ...
                    itemData={{
                      ...
                      date: post.date,
                      tags: post.tags,
                      community: post.community || communityName,
                      communityId: id,
                      type: communityType,
                      author: post.author,
...
export default MobileCommunityForumPage;
